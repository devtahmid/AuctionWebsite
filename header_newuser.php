...
<body id="page-top">
    <nav class="navbar navbar-dark bg-secondary navbar-expand-lg ">
        <a class="navbar-brand font-weight-bold col" href="login_form.php">Auctionit</a>
        ...
        <div class="collapse navbar-collapse row" id="navbarTogglerDemo02">
            <form class="form-inline my-2 my-lg-0 col-lg-7 px-5 mx-auto" action="search.php" method="post">
            ...
            <ul class="navbar-nav mt-2 mt-lg-0 col-lg-5">
                ...
                ?>
                    <li class="nav-item ml-lg-auto">
                        <a class="nav-link font-weight-bold text-white pl-5 pl-lg-3" href="registration_form.php">Register <span class="sr-only">(current)</span></a>
                    </li>
                <?php
                } else {
                ?>
                    <li class="nav-item ml-lg-auto">
                        <a class="nav-link font-weight-bold text-white pl-5 pl-lg-3" href="login_form.php">Login <span class="sr-only">(current)</span></a>
                    </li>
                <?php
                }
                ?>
